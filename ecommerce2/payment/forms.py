...
class OrderForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'mobile': forms.TextInput(attrs={'class':'form-control','placeholder':'+9940773332222'}),
            'city': forms.TextInput(attrs={'class':'form-control','placeholder':'Baku'}),
            'address': forms.TextInput(attrs={'class':'form-control','placeholder':'Filankes filankesov kucesi'}),
            'zip_code': forms.TextInput(attrs={'class':'form-control','placeholder':'AZE1234'}),
    ...
    def save(self,customer,basketlist,coupon):
        ...
        for basketitem in basketlist:
            op = OrderedProduct(
                ...
                color = basketitem.product.title,
            )
